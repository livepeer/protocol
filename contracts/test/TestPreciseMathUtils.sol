...
contract TestPreciseMathUtils {
    function test_validPerc() public {
        ...
        Assert.equal(PreciseMathUtils.validPerc(10 ** 27 + 1), false, "1 more than the max should not be valid percentage");
    }
    ...
    function test_percPoints() public {
        Assert.equal(PreciseMathUtils.percPoints(3, 4), 750000000000000000000000000, "3/4 should convert to valid percentage");
        Assert.equal(PreciseMathUtils.percPoints(100, 300), 333333333333333333333333333, "100/300 should convert to valid percentage");
    }
}
