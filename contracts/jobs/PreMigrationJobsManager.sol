...
contract PreMigrationJobsManager is ManagerProxyTarget, IVerifiable, IJobsManager {
    ...
    function PreMigrationJobsManager(address _controller) public Manager(_controller) {}
